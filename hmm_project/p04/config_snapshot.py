...
Snapshot of the config used to produce the robustness-check p=0.04 results
documented in report.md Section 7.4 and archived under hmm_project/p04/results/.
